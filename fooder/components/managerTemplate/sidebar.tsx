 ...
 const Sidebar = ({ children, id, title, menuList }: ManagerProp) => {
    ...
    return (
        <div className="w-full min-h-dvh bg-slate-50">
            ...
            {/* header section */}
           <header className="flex justify-between items-center p-4 mb-0 bg-primary shadow-md bg-black">
               ...
               <div className="relative">
                   <button onClick={toggleDropdown} className="flex items-center space-x-2 text-yellow-300">
                   ...
                   <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10 top-full">
                       <a href="#" className="block px-4 py-2 text-sm text-gray-900 hover:bg-gray-100">Profile</a>
                       <a href="#" className="block px-4 py-2 text-sm text-gray-900 hover:bg-gray-100">Settings</a>
           ...
           bg-white border-r border-primary ${isShow ? `translate-x-full` : ``}`}>
               ...
               {/* user section */}
               <div className="w-full mt-10 mb-6 bg-primary text-orange-500  p-3 flex gap-2 items-center">
